...
class menuState {
    create() {
        ...
        let hostLabel: Phaser.Text = game.add.text(80, game.world.height - 500, 'Press the "H" key to host a game', { font: '25px Arial', fill: '#ffffff' });
        ...
        let hostKey: Phaser.Key = game.input.keyboard.addKey(Phaser.Keyboard.H);
